...
class HotelManagementSystem:
    def __init__(self,root):
        ...
        # DETAILS BUTTON
        det_btn=Button(btn_frame,text="DETAILS",command=self.room_details,width=22,font=("times new roman",12,"bold"),bg="black",fg="pink",bd=0,cursor="hand1")
        ...
        # LOGOUT BUTTON
        log_btn=Button(btn_frame,text="LOGOUT",command=self.logout,width=22,font=("times new roman",12,"bold"),bg="black",fg="pink",bd=0,cursor="hand1")
    ...
    ####################### creating function that connects our details file #############################
    ...
    def logout(self):
        self.root.destroy()
        import login
        # Reloading module in case it was imported before and cached? 
        # Usually import is cached. Ideally we just use the module validly.
        import importlib
        importlib.reload(login)
        
        root = Tk()
        app = login.CleanLoginApp(root)
        root.mainloop()
